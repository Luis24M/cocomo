      ...
      <main className="container max-w-4xl mx-auto py-8 px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Estimación profesional de costos de software utilizando modelos
            COCOMO estándar de la industria. Selecciona un modelo para comenzar
            tu estimación.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-6  gap-6">
          ...
          <div className="col-span-1 md:col-span-2">
            <ModelCard
              title="PUNTOS DE CASO DE USO"
              description="Estimación basada en casos de uso del sistema"
              intro="Estimación basada en casos de uso del sistema, ideal para proyectos orientados a objetos"
